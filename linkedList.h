...
class linkedListType
{
   ...
   private:
      ...
      void listKiller();
      //Function to termiante the list
      //Postcondition: List is terminated and program ends  
...
linkedListType<Type>::~linkedListType()
{
   this->listKiller(); //list killer called
}
...
{
   this->listKiller(); //ListKiller called
}
