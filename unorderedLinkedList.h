...
public:
      ...
      void deleteLargest();
      //Function to delete the largest item in the list
      //Postcondition: The largest item in the list is found
      //               after this is done the funciton will return 
      //               the list again witht the largest item deleted.
};
